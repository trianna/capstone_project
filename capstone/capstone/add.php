...
?>
<div class="page-header"><h3>Add a document</h3></div>
<?php
...
<form action="add.php" method="POST">
    ...
    <div class="form-group">
      ...
      <input name="date_published" type="text" class="form-control">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label class="col-form-label" for="inputDefault">ISBN-13</label>
      <input name="isbn13" type="text" class="form-control">
    </div>
    
    <p><button type="submit" class="btn btn-primary btn-sm" name="submit" value="Login">Submit</button>
    <button type="reset" class="btn btn-primary btn-sm" name="reset" value="Login">Reset</button></p>
